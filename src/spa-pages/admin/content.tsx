...
import { getSiteContent, updateSiteContent, type SiteContentRecord } from "@/lib/api";
    ...
    <AdminLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Edit homepage text, metrics, service cards, and contact details.</p>
        </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <FormField control={form.control} name="heroAccent" render={({ field }) => (
                  <FormItem><FormLabel>Hero Accent</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>
                )} />
              </div>
              ...
              <FormField control={form.control} name="metrics" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Textarea rows={5} placeholder="15+ | Years Experience" {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <FormField control={form.control} name="mentorshipTitle" render={({ field }) => (
                  <FormItem><FormLabel>Mentorship Title</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>
                )} />
                <FormField control={form.control} name="mentorshipSubtitle" render={({ field }) => (
                  <FormItem><FormLabel>Mentorship Subtitle</FormLabel><FormControl><Textarea rows={3} {...field} /></FormControl><FormMessage /></FormItem>
                )} />
              </div>
              ...
              <FormField control={form.control} name="services" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Textarea rows={6} placeholder="Personalized Mentorship | Description..." {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <FormField control={form.control} name="aboutHighlights" render={({ field }) => (
                  <FormItem>
                    <FormLabel>About Highlights</FormLabel>
                    <FormControl><Textarea rows={5} placeholder="Course shortlisting" {...field} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
